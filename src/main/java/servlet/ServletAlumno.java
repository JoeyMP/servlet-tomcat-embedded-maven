...
public class ServletAlumno extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println(request.getParameter("facultad"));
        System.out.println(request.getParameter("escuela"));
        request.setAttribute("facultad",request.getParameter("facultad"));
